...
#submit_stampede2_serial generates temporary slurm submission files and submits them
#Inputs:
#  (1) Job Name
#  (2) Time (in hours:minutes:seconds format)
#  (3) Script
function submit_stampede2_serial {
...
#submit_stampede2_parallel generates temporary slurm submission files and submits them
#Inputs:
#  (1) Job Name
#  (2) Time (in hours:minutes:seconds format)
#  (3) Number of nodes (N)
...
#  (5) Script
function submit_stampede2_parallel {
